...
//ambil data dari tabel det_parkir/ query data det_parkir  
$result = mysqli_query($con, "SELECT det_parkir.*, kendaraan.nama_pemilik, kendaraan.jenis_kendaraan, kendaraan.plat, kendaraan.merk_kendaraan, users.nama_admin
        FROM det_parkir
        JOIN users ON det_parkir.id_user = users.id_user
        JOIN kendaraan ON det_parkir.plat = kendaraan.plat");

//ambil data det_parkir dari object result
// while ($detail = mysqli_fetch_assoc($result)) {
//     var_dump($detail["plat"]);
// }
