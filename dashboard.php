    ...
    <div id="sidebar-collapse" class="wrapper">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="auth" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link">Income hari ini</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link">History parkir</a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="main p-3 ">
            <div class="">
                <h1>
                    Selamat Datang!
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officiis in quis veniam. A rem sunt, ea tempora deleniti doloribus commodi.</p>
                </h1>
